...
_detach(){oX(oJ(this.source),e=>{iT(e)&&iI(e,this)}),this._active.clear(),li(this)}/** @internal */eventObserved(e){"change"==e.type?e.idle?this.advance():(this._active.add(e.parent),this._start()):"idle"==e.type?this._active.delete(e.parent):"priority"==e.type&&(this.priority=oJ(this.source).reduce((e,t)=>Math.max(e,(aI(t)?t.priority:0)+1),0))}};function lr(e){return!1!==e.idle}function lo(e){return!e.size||Array.from(e).every(lr)}function li(e){e.idle||(e.idle=!0,oX(i8(e),e=>{e.done=!0}),iO(e,{type:"idle",parent:e}))}oP.assign({createStringInterpolator:iG,to:(e,t)=>new ln(e,t)}),it.advance;// src/applyAnimatedValues.ts
...
function(e,t){let n=se(e,!0,"fixed"===t),r=n.top+e.clientTop,o=n.left+e.clientLeft,i=lK(e)?l9(e):lE(1),a=e.clientWidth*i.x,l=e.clientHeight*i.y,s=o*i.x,u=r*i.y;return{width:a,height:l,x:s,y:u}}(t,n);else{let n=l7(e);r={...t,x:t.x-n.x,y:t.y-n.y}}return lI(r)}function sr(e,t){return lK(e)&&"fixed"!==l1(e).position?t?t(e):e.offsetParent:null}// Gets the closest ancestor positioned element. Handles some edge cases,
